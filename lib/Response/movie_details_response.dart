...
MovieDetailResponse movieDetailResponseFromMap(String str) => MovieDetailResponse.fromMap(json.decode(str));

String movieDetailResponseToMap(MovieDetailResponse data) => json.encode(data.toMap());
